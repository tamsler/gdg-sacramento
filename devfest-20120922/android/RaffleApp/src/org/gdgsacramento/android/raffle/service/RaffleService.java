...
public class RaffleService implements AppConstants {
	...
	public void postRaffle(String raffleName, final ResultHandler<String> resultHandler) {
		...
		// Create Http Task
		HttpTask httpTask = new HttpTask(httpRequestArgs, HttpStatus.SC_OK, HTTP_POST, new AbstractHttpTaskNotifier() {
